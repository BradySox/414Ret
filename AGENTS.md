...
If the current branch is behind `main`, merge or rebase before editing anything. Never
derive the state of the codebase from memory — always read the current files.
