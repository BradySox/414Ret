...
64. **Carrier deck spawn policy** — six-pack as last resort plus the MP slot-timing fix; Tomcats spawn a second behind the rest of the deck so the port-quarter pair goes to the Hornets. The deck is counted as it empties: packages park in waves, at most 16 jets and 4 Tomcats at once, and the rest start airborne.
