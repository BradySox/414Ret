...
89. **Living battlespace pre-roll** — phase-aware mid-cycle mission starts: the turn's earlier packages are already airborne, on station or recovering when you walk out.
