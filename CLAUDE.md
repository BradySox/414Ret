...
### Upstream PR ledger (**refreshed live 2026-07-19** during the upstream sync — 36 PRs: 8 open / 8 merged / 20 closed. **Three fork PRs merged upstream 2026-07-19** (#805/#843/#854) and geofffranks' #859 (the §56 motorpool source) landed the same day — all four reconciled back into the fork in the `sync/upstream-dev-2026-07-19` merge. Still re-verify with `gh` before acting; this goes stale fast.)
