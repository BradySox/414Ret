...
- **Process** — `414th-verification-cadence-notes.md` (the fly-card throttle, proposed),
  ...
  reopen it),
  `414th-grimes-repos-assessment-notes.md` (**the licence gate on Grimes' code, and the one
  repo worth reading** — his published in-game unit dump is a second ground truth for sensor
  ranges; MIST and SLmod are GPL-3 and `DCS-miscScripts` is unlicensed, so none of it may be
  vendored into this LGPL-3 tree)
...
### Grimes (mrSkortch) — read-only, licence-gated (ASSESSED 2026-08-20)

Grimes wrote MIST and SLmod and maintains the Hoggit scripting wiki. His 7 repositories were
assessed in full; **one is worth reading and none may be copied.**
...
- **The one live repo is `DCS-miscScripts`** (updated Feb 2026). `ObjectDB2/everyObject.lua` is a
...
[414th-grimes-repos-assessment-notes.md](docs/dev/design/414th-grimes-repos-assessment-notes.md).
