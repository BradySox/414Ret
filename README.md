...
- A carrier launches in waves, and aircraft that do not fit no longer vanish. A package
  parks only while the deck has room — at most 16 jets and 4 Tomcats at once, each jet
  holding its spot until five minutes after its planned takeoff. A package that does not
  fit starts airborne whole. Player flights always keep their deck spot.
