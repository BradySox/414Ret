...
* **[Campaign]** **A ground object on an airfield's runway strip or apron is named at New Game.** DCS holds every AI fixed-wing taxi at a field that has a ground unit on its taxiways; on Long Road to H3 the campaign's own Incirlik EWR marker sat 265 m off the runway centreline on the south-west taxiway and nothing launched until it was moved by hand. Generation now checks every ground object against each field's runway band (300 m either side, 1.6 km along) and its stands (80 m) and logs a warning naming the group, the field and the offsets. Warn only; nothing is moved. The Incirlik EWR and Al Qusayr armor markers in the Long Road to H3 campaign file are moved 650–700 m off their taxiways. NEW game required for the campaign fix.
...
* **[Mission Generation]** **Tomcats no longer spawn on the port-quarter deck spots.** DCS hands out carrier deck spots in spawn order, and the pair at the stern's port corner was the first it offered an F-14 once the six-pack was closed. F-14 groups now activate a second behind every other carrier group, so the Hornets hold that pair and the Tomcats are placed further along the deck. Needs a few non-Tomcat jets spawning on the same boat; a Tomcat activated at its push time later in the mission still takes whatever is free. NEW mission required.
