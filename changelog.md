...
* **[Campaigns]** **Northern Russia: blue flies from three fields instead of one.** Kutaisi held blue's entire land wing — 16 squadrons on 58 slots — and is now **the A-10 and helicopter base**, with the two Warthog squadrons at 12 apiece and the Apache, Hokum, Huey, Hip and Hind at 5. **Batumi and Gudauta join the campaign as blue airfields** (they are on the Caucasus map but were not control points here). The Viggen and Mirage go to **Batumi**; the Vipers, JF-17s and Floggers plus every tanker, the AWACS and the Hercules go to **Gudauta**, which is the only field out there with enough large stands — Batumi has room for exactly **two** heavy aircraft. Blue's land parking goes from 58 slots to 99 and its aircraft from 58 to 90, so squadrons are 8-12 strong instead of 4-5. The trade is transit: both new fields are ~50 NM further from the fighting than Kutaisi. **Sizing now respects the stand sizes, not just the slot count.** A Hind needs a bigger stand than a Huey and only 13 of Kutaisi's 58 take one, so counting slots alone would have parked 28 helicopters in 25 helicopter-capable spots. Re-checking the **red** fields under the same rule found two more: **Beslan** had a Flanker squadron and a Hind squadron of five each competing for the **five** large stands it has, and **Tbilisi-Lochini** held 74 aircraft when its jets fit only **70** of its 74 stands. Beslan is now 3 Flankers and 2 Hinds beside its ten Fulcrums, and Tbilisi drops from 74 aircraft to 70. NEW game required.
