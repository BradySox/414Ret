...
* **[Mission Generation]** **The F-22A's and Super Hornet's modern missiles are era-gated now — including the Raptor's hypersonics.** The AIM-120D, AIM-260A, Block II Sidewinder and **Mako hypersonic** stores those two packs ship had no entry in Retribution's weapon date data — and a weapon that isn't listed is treated as **available in every era, with no fallback**. That wasn't academic: the Raptor's shipped loadouts carry the AIM-120D in 12 fits and **two Mako hypersonic missiles in all six** of its air-to-air fits, so with *Restrict weapons by campaign date* switched on, an F-22A in a **2006** campaign was flying hypersonic AAMs. All four now sit on a proper ladder (AIM-120C → AIM-120D → AIM-260A → Mako) and step down correctly in the six shipped pre-2019 campaigns that field these mods — Clash of the Titans, Operation Vectron's Claw, Red Sea Rising, The Anvil of War, Exercise Vegas Nerve and Operation Desert Aladeen, where the Raptor now falls back to a period-correct AMRAAM. **The two campaigns actually set in 2027 — Baltic Fury and Marianas 2027 — keep the exact Raptor fit they ship with today**, and nothing changes at all unless you play with weapons-by-date enabled.
