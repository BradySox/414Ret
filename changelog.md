...
* **[Campaigns]** **Northern Russia: blue flies from three fields instead of one.** Kutaisi held blue's entire land wing — 16 squadrons on 58 slots — and is now **the A-10 and helicopter base**, with the two Warthog squadrons at 12 apiece and the Apache, Hokum, Huey, Hip and Hind at 5. **Batumi and Gudauta join the campaign as blue airfields** (they are on the Caucasus map but were not control points here). The **Strike Eagles** go to **Batumi**; the **Vipers and Eagles** plus every tanker, the AWACS and the Hercules go to **Gudauta**, which is the only field out there with enough large stands — Batumi has room for exactly **two** heavy aircraft. Blue's land wing is also **the correct one now**: the campaign shipped blue a MiG-23, a JF-17, a Mirage, a Viggen, a Ka-50 and a pair of Hips and Hinds, and it now flies the F-15C, F-15E, F-16CM, A-10C, Kiowa and Huey it should, with a Tomcat/Hornet air wing on the boat and Apaches and Chinooks on the LHA. Squadrons are 10-12 strong instead of 4-5. The trade is transit: both new fields are ~50 NM further from the fighting than Kutaisi. **Sizing now respects the stand sizes, not just the slot count.** A Hind needs a bigger stand than a Huey and only 13 of Kutaisi's 58 take one, so counting slots alone would have parked 28 helicopters in 25 helicopter-capable spots. Re-checking the **red** fields under the same rule found two more: **Beslan** had a Flanker squadron and a Hind squadron of five each competing for the **five** large stands it has, and **Tbilisi-Lochini** held 74 aircraft when its jets fit only **70** of its 74 stands. Tbilisi drops from 74 aircraft to 70, and **Beslan's Hind squadron moves to Nigniy Pasanauri FOB** — which had four helicopter pads and nothing on them, sits 59 NM from the fighting against Beslan's 19, and frees the large stands the Flankers were sharing with it. The Flankers go from 3 to 5 and the Hinds from 2 to 4. NEW game required.
