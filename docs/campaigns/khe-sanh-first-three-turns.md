...
[campaign plan](khe-sanh-campaign-handbook.md#6--campaign-conops--the-phase-plan):
...
Per the [campaign plan](khe-sanh-campaign-handbook.md#6--campaign-conops--the-phase-plan), the
...
[Vietnam Campaign Layer](https://github.com/bradyccox/414Ret/wiki/Vietnam-Campaign-Layer) (the will/ROE mechanics) ·
[Vietnam Ops](https://github.com/bradyccox/414Ret/wiki/Vietnam-Ops) (the period runtime suite). Callsigns/freqs/code words here are
