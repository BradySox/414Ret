...
*A filled-in model for the [Campaign Briefing Handbook](red-tide-campaign-handbook.md) mission-brief
template. These three turns walk Phases 0→2 of the [phase plan](red-tide-campaign-handbook.md#5--campaign-conops--the-phase-plan):
...
Per the [phase plan](red-tide-campaign-handbook.md#5--campaign-conops--the-phase-plan): finish
...
[Role kneeboard cards](red-tide-role-cards.md) ·
[Intel assessment (lore)](red-tide-intel-assessment.md) ·
[Visual briefing](red-tide-visual-briefing.md). Callsigns/freqs/code words here are illustrative and
