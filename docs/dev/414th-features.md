...
coastal anti-ship batteries that should threaten it sat idle. §77 turns it into a real
...
on/off/non-coastal). **Checklist B31** — needs an in-game pass: whether a DCS Silkworm on
