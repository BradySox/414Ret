...
### B24 — Expanded F-4E Weapons Pack: HARM Weasel fits · §71 · ☐ UNTESTED (built 2026-07-18; the (XW) selection, the Shrike fallback, the editor hiding, and the 1988 era-gate tripwire are unit-tested in `tests/fourteenth/test_f4e_expanded_weapons.py` and the Red Tide no-preseed is pinned — whether DCS itself mounts and employs the injected AGM-88s on the Heatblur F-4E is mod/DCS-only)
