...
| B110 | A package's escort holds the striker's pace instead of running ahead | §8 cruise mach | ☐ |
...
### B110 — A package's escort holds the striker's pace instead of running ahead · §8 cruise mach · ☐ UNTESTED
