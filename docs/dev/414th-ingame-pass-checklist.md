...
| B83 | Tankers orbit at their own base, and each carrier gets one | planner shape | ☐ |
...
### B83 — Tankers orbit at their own base, and each carrier gets one · planner shape · ☐ UNTESTED
