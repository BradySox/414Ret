...
- **First ground-AD cruise-missile intercept observed (2026-07-17 flown Noisy Cricket, Tacview `Tacview-20260717-172716`):** a red Tor killed one of the 6 raid BGM-109s ~12.7 km short of the aimpoint — INSIDE the 8 NM defender-wake ring — and 5/6 impacted the target. Suggestive of the wake working but **not conclusive**: the same mission's Tors were also engaging JSOW glide bombs at their own sites (5 intercepts), which makes them hot without §63's help. A raid against a quiet (un-bombed) defended target is still the clean wake test.
...
### S2 — Mobile missile sites relocate (the SCUD hunt) · §49 · ◐ PARTIAL (scoot + fire + fire-window all VERIFIED for vanilla SCUD 2026-07-17; residual = the CH Shahed post-fire pin (give-up mitigation unflown) + the FPS fixes unflown)
- **2026-07-17 evening fly (PG "Noisy Cricket" 39-site game, Tacview
