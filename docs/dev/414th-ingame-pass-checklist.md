...
- **Deliberately not in scope:** Kharg Island (565 km from the nearest airfield of either campaign — parked until ED's southern Iraq extension; needs the pydcs pin bump before a CP can bind there) and rail interdiction (§35 is road-graph-only; new engine work).
