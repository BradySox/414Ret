...
Over the 55 shipped zones on a 2004 campaign that is **15 SA-3, 15 Hawk, 13 SA-11, 8
...
its inventory was Soviet, and 8 of the 55 zones have no lean at all. So the east
...
- **Borders ship with the terrain**, built by `tools/build_terrain_borders.py` from
  public-domain GeoJSON into `resources/borders/*.yaml` -- 8 terrains, 7,093 vertices at a
...
- **Borders are terrain data, not campaign data.** ✅ `resources/borders/<terrain>.yaml`,
  8 terrains, 7,093 vertices, generated by `tools/build_terrain_borders.py` —
