...
any of it. Features doc §96 carries the file list; B114 passed 2026-09-01, B115 owed.
...
same two. The §96 rows are **B114/B115** now.
...
collisions is a pattern -- failed on it immediately. §96 is **B114/B115** now.
