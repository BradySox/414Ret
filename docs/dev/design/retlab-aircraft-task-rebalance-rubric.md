# RetLab aircraft task-priority rebalance rubric

Status: **MAGNITUDES SUPERSEDED** (2026-08-09). The planner re-convergence decision
(see the DECIDED block in `retlab-autoplanner-upstream-divergence-audit.md`, work
...
- **Support / capability-gated tasks are preserved verbatim**: `Refueling, AEW&C, Recovery,
  ...
  not preference-balanced, and several are RetLab feature wiring (TARPS, Jamming).
...
`tests/retlab/test_s3b_viking_sea_control.py`, including the mod-off carrier-tanker
