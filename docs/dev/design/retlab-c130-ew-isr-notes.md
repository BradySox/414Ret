# RetLab C-130J EW/ISR Notes

## Source of truth

RetLab's scripted electronic-warfare gameplay is the C-130J-30 JAMMING
...
- It added AI SEAD/DEAD waypoint script hooks and package threat-reaction
  changes that were separate from RetLab C-130J EW/ISR design.
...
only for third-party aircraft-data compatibility; they no longer drive RetLab EW
mission scripting.

## IADS engine interaction (MANTIS / Skynet)

> **2026-09-12:** Skynet is the engine again and the MANTIS bridge is gone
> (`retlab-skynet-return-notes.md`). The Skynet paragraph below is the live one; the MANTIS
...
- Fighter/attack aircraft ECM pods still exist as loadout equipment and DCS
  native ECM settings, but they do not create a scripted RetLab F10 jammer menu.
