...
> `retlab-mist-moose-shim-notes.md` (deleted 2026-09-12 with the shim; see `retlab-skynet-return-notes.md`). This doc is kept for the
...
**Date:** 2026-06-24
**Parent:** [`retlab-framework-consolidation-notes.md`](retlab-framework-consolidation-notes.md) phase 4.
...
RetLab CH-47 AGL/`inAir()` workaround.
...
4. **Validation (5–7 d):** in-game pass across airlift / air-assault / logistics missions (default-on
   ⇒ must be thorough). Add rows to `retlab-ingame-pass-checklist.md`.
