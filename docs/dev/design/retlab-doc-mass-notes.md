# RetLab — documentation mass

`retlab-features.md` was 104,332 words across 91 sections, edited 379 times in 60 days — the
...
- §55 Red Intent already tried the obvious "make red smarter" shape. Read seam 7 of
  `retlab-retribution-long-view.md` before proposing another.
...
- `retlab-features.md` — the Threat Intel Brief still said a card's ring and HARM code were
...
- `retlab-coin-HANDOFF.md` — still said TARPS confirms a suspect contact.
