...
**Date:** 2026-06-24
**Parent:** [`retlab-framework-consolidation-notes.md`](retlab-framework-consolidation-notes.md) phase 2.
...
| Default | off | off |
| Authorship | upstream Steggles, unmodified | **RetLab** (canonical) |
...
- `resources/plugins/ewrs/ewrs.lua` — unmodified upstream Steggles code (no RetLab patches); ~13 MIST
