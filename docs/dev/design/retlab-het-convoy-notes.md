...
[retlab-dcs-update-2026-08-26-notes.md](retlab-dcs-update-2026-08-26-notes.md) §1.
...
**The transporters are reachable as of 2026-08-26.** pydcs pin `bfdbb4d` carries
...
- **The airlift leg.** Related, and was worse, but separate -- and now done.
  ...
  aircraft. See
  [retlab-airlift-capacity-notes.md](retlab-airlift-capacity-notes.md). The road
