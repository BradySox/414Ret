# RetLab — Player-Manned QRA (design notes)
...
> being purely AI. Read `retlab-air-defense-planning-notes.md` (QRA intent) and
...
README (player-facing) → register in `game/retlab/features.py` → in-game-pass checklist
