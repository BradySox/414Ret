# RetLab — what recon does now that engaging is the only reveal

Status: **candidate A is BUILT** (2026-08-18, same day — see
[retlab-features.md §3](../retlab-features.md), "Recon's one remaining job"). B and C remain
...
[retlab-dcs-update-2026-08-26-notes.md](retlab-dcs-update-2026-08-26-notes.md) §6.3.
...
exact failure mode `retlab-startup-times-notes.md` exists to prevent.
