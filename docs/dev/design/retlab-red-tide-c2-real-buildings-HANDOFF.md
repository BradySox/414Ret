...
>
> The live design record is [`retlab-red-tide-campaign-notes.md`](retlab-red-tide-campaign-notes.md).
...
([`retlab-scenery-import-notes.md`](retlab-scenery-import-notes.md)). It is NOT the same as
