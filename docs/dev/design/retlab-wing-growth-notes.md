...
> `retlab-features.md` §82; this note keeps the design rationale, the ordering principle
...
>
> Split out of `retlab-single-player-loop-notes.md` §S3 reason **5b** at the DM's request,
...
`retlab-red-tide-campaign-notes.md` carried a feature lock from 2026-07-17 that would have
...
| 7 | **414th TFS F-15E** (Nordholz) · **RetLab Strike Rhinos F/A-18F** (carrier) | **Strike phase.** The belt is coming down; now the campaign can bomb properly |
