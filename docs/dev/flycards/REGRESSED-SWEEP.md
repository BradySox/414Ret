# Fly card — clear the carrier rows on one Starfire campaign
...
Also ruled out, so nobody retries it: **Red Tide** has no carrier at all.

---

## Settings

Nothing to set. Leave recon fog on (default). Tacview on.

---

## One mission, two rows

Fly or watch a carrier turn of ordinary length. Both rows are free — they are the fleet you
were flying off anyway.
