...
| Campaign maker | ~~KEEP~~ **REMOVED 2026-08-02** | The 2026-07-18 verdict was KEEP (landed through Increment D). Superseded: the blank-start campaign maker was fully ripped out 2026-08-02 (DM call) — the wizard entry, paint step, finalize/save-as-campaign, and `blanktheatergen`/`blankcampaign` machinery are gone; saved `blank_canvas` campaigns no longer load. |
