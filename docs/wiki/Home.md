...
the *campaign* play like the era — ambush MiGs, Alpha Strikes, era-authentic planner ranges and
taskings, and a red tempo that answers the campaign clock.
...
- **[Operation Enduring Resolve (COIN) — Campaign Briefing](Enduring-Resolve-Campaign-Briefing)** —
  ...
  Disrupt → Clear and Hold → Break the Momentum arc, the carrier's war, and how to fight it.
  Requires the DCS Afghanistan map.
