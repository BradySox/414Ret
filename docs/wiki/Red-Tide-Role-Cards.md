...
[Campaign Briefing Handbook](Red-Tide-Campaign-Briefing) roster. Each card is a kneeboard page:
mission, period loadout, game plan, threat-defeat, comms, SAR. Pair with the
[mission brief](Red-Tide-Campaign-Briefing#7--the-mission-brief-template) for the day's specifics.*
...
*This page is the online copy of [`docs/campaigns/red-tide-role-cards.md`](https://github.com/bradyccox/414Ret/blob/main/docs/campaigns/red-tide-role-cards.md) in the repo. Edit that file; the wiki is mirrored from `docs/wiki/` on merge to `main`.*
