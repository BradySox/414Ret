...
**[red-tide-intel-assessment.md](Red-Tide-Intel-Assessment)**. To **build a brief** — real
...
> reference: the **[Campaign Briefing Handbook](Red-Tide-Campaign-Briefing)**.
...
![Red Tide theater map](https://raw.githubusercontent.com/BradySox/414Ret/main/docs/wiki/img/red_tide_theater_map.png)
...
![Red Tide SAM engagement ranges](https://raw.githubusercontent.com/BradySox/414Ret/main/docs/wiki/img/red_tide_sam_threat.png)
