...
Spec: docs/dev/design/retlab-coin-insurgent-replenishment-notes.md. Retribution's
...
# Design: docs/dev/design/retlab-coin-reinfiltration-notes.md. A staged, announced,
