...
def ensure_enemy_trail_convoy(game: "Game") -> None:
    ...
    from game.retlab.red_tempo import trail_surge_multiplier
...
def _reference_points(game: "Game", coalition: "Coalition") -> list[Any]:
    ...
    below and the §50 ambient-convoy layer (``game/retlab/ambient_convoys.py``).
    """
...
def _seed_trail_source(
    ...
    whitelist (:func:`game.retlab.coin.regen_unit_pool` -- infantry/technicals/
    ...
    """
    if coin:
        from game.retlab.coin import regen_unit_pool
