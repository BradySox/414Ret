...
class Settings:
    ...
    neutral_border_defense: bool = boolean_option(
        ...
        detail=(
            ...
            "it fields and how many scale with the country -- a small one gets "
            "a single SA-3 or Hawk, a large one several S-300s or Patriots, "
            "spread along the stretch of frontier the war is near, each deep "
            "enough that its envelope just reaches the border. Enter and it "
