...
local unitPayloads = {
	...
	["payloads"] = {
		...
		[5] = {
			...
			-- 2x AGM-88C HARM (3/7) + 2x 370gal wing tanks + 2x AIM-120C + AIM-9X + HTS + ECM
			-- (standard Wild Weasel fit: HARM shooters always fly with wing bags)
			["pylons"] = {
				[1]  = { ["CLSID"] = "{5CE2FF2A-645A-4197-B48D-8720AC69394F}", ["num"] = 9 },
				[2]  = { ["CLSID"] = "{40EF17B7-F508-45de-8566-6FFECC0C1AB8}", ["num"] = 8 },
		...
		[8] = {
			...
			-- 2x AGM-65D triple-rack (3/7 = 6 Mavericks) + 2x 370gal wing tanks + AMRAAM/AIM-9X + Sniper
			["pylons"] = {
				[1]  = { ["CLSID"] = "{5CE2FF2A-645A-4197-B48D-8720AC69394F}", ["num"] = 9 },
				[2]  = { ["CLSID"] = "{40EF17B7-F508-45de-8566-6FFECC0C1AB8}", ["num"] = 8 },
		...
		[9] = {
			...
			-- 2x BRU-57 GBU-38 (3/7 = 4 JDAM) + 2x 370gal wing tanks + AMRAAM/AIM-9X + Sniper
			["pylons"] = {
				[1]  = { ["CLSID"] = "{5CE2FF2A-645A-4197-B48D-8720AC69394F}", ["num"] = 9 },
				[2]  = { ["CLSID"] = "{40EF17B7-F508-45de-8566-6FFECC0C1AB8}", ["num"] = 8 },
				[3]  = { ["CLSID"] = "{BRU57_2*GBU-38}", ["num"] = 7 },
				[4]  = { ["CLSID"] = "{F376DBEE-4CAE-41BA-ADD9-B2910AC95DEC}", ["num"] = 6 },
				[5]  = { ["CLSID"] = "ALQ_184", ["num"] = 5 },
				[6]  = { ["CLSID"] = "{F376DBEE-4CAE-41BA-ADD9-B2910AC95DEC}", ["num"] = 4 },
				[7]  = { ["CLSID"] = "{BRU57_2*GBU-38}", ["num"] = 3 },
				[8]  = { ["CLSID"] = "{40EF17B7-F508-45de-8566-6FFECC0C1AB8}", ["num"] = 2 },
				[9]  = { ["CLSID"] = "{5CE2FF2A-645A-4197-B48D-8720AC69394F}", ["num"] = 1 },
				[10] = { ["CLSID"] = "{AN_AAQ_33}", ["num"] = 11 },
			},
		...
		[10] = {
			...
			-- 2x GBU-31 2000lb JDAM (3/7) + 2x 370gal wing tanks + AMRAAM/AIM-9X + Sniper
			["pylons"] = {
				[1]  = { ["CLSID"] = "{5CE2FF2A-645A-4197-B48D-8720AC69394F}", ["num"] = 9 },
				[2]  = { ["CLSID"] = "{40EF17B7-F508-45de-8566-6FFECC0C1AB8}", ["num"] = 8 },
		...
		[11] = {
			...
			-- 2x BRU-57 CBU-105 (3/7 = 4 WCMD SFW) vs parked aircraft + 2x wing tanks + AMRAAM/AIM-9X
			["pylons"] = {
				[1]  = { ["CLSID"] = "{5CE2FF2A-645A-4197-B48D-8720AC69394F}", ["num"] = 9 },
				[2]  = { ["CLSID"] = "{40EF17B7-F508-45de-8566-6FFECC0C1AB8}", ["num"] = 8 },
				[3]  = { ["CLSID"] = "{BRU57_2*CBU-105}", ["num"] = 7 },
				[4]  = { ["CLSID"] = "{F376DBEE-4CAE-41BA-ADD9-B2910AC95DEC}", ["num"] = 6 },
				[5]  = { ["CLSID"] = "ALQ_184", ["num"] = 5 },
				[6]  = { ["CLSID"] = "{F376DBEE-4CAE-41BA-ADD9-B2910AC95DEC}", ["num"] = 4 },
				[7]  = { ["CLSID"] = "{BRU57_2*CBU-105}", ["num"] = 3 },
				[8]  = { ["CLSID"] = "{40EF17B7-F508-45de-8566-6FFECC0C1AB8}", ["num"] = 2 },
				[9]  = { ["CLSID"] = "{5CE2FF2A-645A-4197-B48D-8720AC69394F}", ["num"] = 1 },
				[10] = { ["CLSID"] = "{AN_AAQ_33}", ["num"] = 11 },
			},
		...
		[12] = {
			...
			-- 2x GBU-31(V)3 penetrator (3/7) + 2x 370gal wing tanks + AMRAAM/AIM-9X + Sniper
			["pylons"] = {
				[1]  = { ["CLSID"] = "{5CE2FF2A-645A-4197-B48D-8720AC69394F}", ["num"] = 9 },
				[2]  = { ["CLSID"] = "{40EF17B7-F508-45de-8566-6FFECC0C1AB8}", ["num"] = 8 },
