...
The c130j EW/ISR plugin claims every C-130J-30 by airframe. A transport or
paradrop C-130J-30 must fly clean, but the previous fix skipped the whole plugin for
the mission -- which also stripped EW from a co-present JAMMING C-130J-30. Now the
generator emits a per-group deny-list (``dcsRetribution.EwExcludedGroups``) that the
plugin honors, so only the non-EW aircraft are skipped and the EW jet keeps its systems.
"""
