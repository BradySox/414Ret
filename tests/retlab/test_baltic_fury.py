...
from game.retlab.victory import parse_victory
...
def test_air_wing_binds_including_the_carrier(tmp_path: Path) -> None:
    ...
    # Nordholz = RetLab land wing (F-22 + F-15E).
...
def test_iads_coastal_naval_belt(tmp_path: Path) -> None:
    ...
    # the one air-defence role the IADS never holds dark, which is what keeps the
