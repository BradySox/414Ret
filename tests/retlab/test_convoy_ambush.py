...
-- ``tests/retlab/test_ambient_convoys.py`` -- or any organic transfer; the roll covers
them all.)
"""
...
import game.retlab.coin as coin_module
import game.retlab.convoy_ambush as convoy_ambush_module
from game.retlab.convoy_ambush import (
    AMBUSH_TEAM_SIZE,
