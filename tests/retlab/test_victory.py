...
Locks the contracts from docs/dev/design/retlab-victory-conditions-notes.md:
...
from game.retlab import victory as victory_mod
from game.retlab.victory import (
    VictoryCondition,
    VictoryProfile,
