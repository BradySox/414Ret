...
def test_vietnam_reserves_fighters_for_strike_escort() -> None:
    ...
    # Every other era plans BARCAP at stock volume. Modern carried a reserve of 8
    # from 2026-08-03 until the planner re-convergence reverted it: the lever stays
    # for the era that needs it, but an ordinary campaign gets upstream's ATO.
    for d in (MODERN_DOCTRINE, COLDWAR_DOCTRINE, WWII_DOCTRINE):
