"""Guard RetLab's tamed altitude winds.
...
~45-60 kt winds aloft; RetLab pulled them down so winds stay flyable. This fails CI if an
...
# RetLab cap on the upper-level Weibull scale (knots) -- tamed from upstream's 18-22. The
