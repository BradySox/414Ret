"""Build a terrain's shipped §97 border file (``resources/borders/<terrain>.yaml``).

Borders are a property of the map, not of a campaign, so they are generated once
per terrain and every campaign on that map gets them. This is what makes §97
...
def main() -> None:
    ...
    lines = [
        f"# §97 border geometry for the {args.terrain} map. GENERATED by",
